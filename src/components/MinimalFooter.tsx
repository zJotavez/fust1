...
export default function MinimalFooter({ content, currentLang = "pt" }: MinimalFooterProps) {
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-right space-y-3">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-x-6 gap-y-2 text-[9px] font-mono tracking-wider uppercase font-bold text-fust-gold-light">
              ...
              {/* Privacy Policy — opens inline modal */}
              <button
              ...
              {/* Support contact — WhatsApp / phone */}
              <a
                href="https://wa.me/5583997515778"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors duration-300"
                title="+55 83 9975-1577"
              >
